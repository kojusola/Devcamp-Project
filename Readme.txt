...
4.Selecting the cart icon on the navbar would lead to the cart management page allowing the management of the
...
Naming the different classes in such a way that i could remember easily
Changing the bootstrap classes and forgeting to change it in the styling sheet.
Aligning the font awesome icons with other texts on the navbar.

Missing Requirement:
Confirmation page to show successful checkout requires javascript for my design. 
